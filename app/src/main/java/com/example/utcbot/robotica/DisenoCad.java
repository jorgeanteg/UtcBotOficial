...
public class DisenoCad extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diseno_cad);
        ...
        View secondLayout = getLayoutInflater().inflate(R.layout.video_cad, null);

        textoVoz = MediaPlayer.create(this, R.raw.cad);
    ...
    private void mostrarDialogoPersonalizado() {
        ...
        View dialogView = inflater.inflate(R.layout.video_cad, null);
