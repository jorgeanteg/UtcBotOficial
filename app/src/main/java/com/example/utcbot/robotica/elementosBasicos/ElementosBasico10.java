...
public class ElementosBasico10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elementos_basico10);
        ...
        cerrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayer.start();
                Intent intent = new Intent(ElementosBasico10.this, MainActivity.class);
        ...
        siguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer.start();
                Intent intent = new Intent(ElementosBasico10.this, ElementosBasico8.class);
                startActivity(intent);
            }
        });
        ...
        textoVoz = MediaPlayer.create(this, R.raw.sonido9);
        segundoSonido = MediaPlayer.create(this, R.raw.condensador);
    ...
    private void mostrarDialogoPersonalizado() {
        ...
        View dialogView = inflater.inflate(R.layout.condensador, null);
