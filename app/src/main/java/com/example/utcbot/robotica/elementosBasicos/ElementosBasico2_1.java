...
public class ElementosBasico2_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elementos_basico21);
        ...
        cerrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayer.start();
                Intent intent = new Intent(ElementosBasico2_1.this, MainActivity.class);
        ...
        siguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer.start();
                Intent intent = new Intent(ElementosBasico2_1.this, ElementosBasico4.class);
                startActivity(intent);
            }
        });
        ...
        textoVoz = MediaPlayer.create(this, R.raw.sonido5);
        segundoSonido = MediaPlayer.create(this, R.raw.mpu);
    ...
    private void mostrarDialogoPersonalizado() {
        ...
        View dialogView = inflater.inflate(R.layout.azul_mpu, null);
