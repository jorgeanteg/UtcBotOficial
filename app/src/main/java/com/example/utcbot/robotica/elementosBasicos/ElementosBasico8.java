...
public class ElementosBasico8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elementos_basico8);
        ...
        cerrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayer.start();
                Intent intent = new Intent(ElementosBasico8.this, MainActivity.class);
        ...
        siguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer.start();
                Intent intent = new Intent(ElementosBasico8.this, ElementosBasico9.class);
                startActivity(intent);
            }
        });
        ...
        textoVoz = MediaPlayer.create(this, R.raw.sonido10);
        segundoSonido = MediaPlayer.create(this, R.raw.bateria);
    ...
    private void mostrarDialogoPersonalizado() {
        ...
        View dialogView = inflater.inflate(R.layout.bateria, null);
