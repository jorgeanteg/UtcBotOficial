...
public class ElementosBasico11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elemento_basico11);
        ...
        cerrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayer.start();
                Intent intent = new Intent(ElementosBasico11.this, MainActivity.class);
        ...
        siguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer.start();
                Intent intent = new Intent(ElementosBasico11.this, ElementosBasico12.class);
                startActivity(intent);
            }
        });
        ...
        textoVoz = MediaPlayer.create(this, R.raw.sonido13);
        segundoSonido = MediaPlayer.create(this, R.raw.cables);
    ...
    private void mostrarDialogoPersonalizado() {
        ...
        View dialogView = inflater.inflate(R.layout.cables, null);
