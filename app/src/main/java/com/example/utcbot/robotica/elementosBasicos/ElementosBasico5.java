...
public class ElementosBasico5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elementos_basico5);
        ...
        cerrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayer.start();
                Intent intent = new Intent(ElementosBasico5.this, MainActivity.class);
        ...
        textoVoz = MediaPlayer.create(this, R.raw.sonido7);
        segundoSonido = MediaPlayer.create(this, R.raw.sensor_touch);
    ...
    private void mostrarDialogoPersonalizado() {
        ...
        View dialogView = inflater.inflate(R.layout.sensor_touch, null);
