...
public class ElementosBasico1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elementos_basico1);
        ...
        cerrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayer.start();
                Intent intent = new Intent(ElementosBasico1.this, MainActivity.class);
        ...
        siguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer.start();
                Intent intent = new Intent(ElementosBasico1.this, ElementosBasico3.class);
                startActivity(intent);
            }
        });

        textoVoz = MediaPlayer.create(this, R.raw.sonido2);
